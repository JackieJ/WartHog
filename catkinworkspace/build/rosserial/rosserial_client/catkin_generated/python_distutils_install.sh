...
cd "/home/robo/Projects/WartHog/catkinworkspace/src/rosserial/rosserial_client"
...
/usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/robo/Projects/WartHog/catkinworkspace/src/rosserial/rosserial_client/setup.py" \
    build --build-base "/home/robo/Projects/WartHog/catkinworkspace/build/rosserial/rosserial_client" \
    install \
    $DESTDIR_ARG \
