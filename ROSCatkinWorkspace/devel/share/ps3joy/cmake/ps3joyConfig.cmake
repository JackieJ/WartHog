...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif(IS_DIRECTORY /home/robo/Projects/ROSCatkinWorkspace/src/joystick_drivers/ps3joy/${idir})
      set(include /home/robo/Projects/ROSCatkinWorkspace/src/joystick_drivers/ps3joy/${idir})
    else()
      message(FATAL_ERROR "Project 'ps3joy' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robo/Projects/ROSCatkinWorkspace/src/joystick_drivers/ps3joy/${idir}'.  Ask the maintainer 'Jonathan Bohren <jbo@jhu.edu>' to fix it.")
    endif()
