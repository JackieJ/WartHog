...
if(FALSE)
  set(ps3joy_SOURCE_PREFIX /home/robo/Projects/ROSCatkinWorkspace/src/joystick_drivers/ps3joy)
  set(ps3joy_DEVEL_PREFIX /home/robo/Projects/ROSCatkinWorkspace/devel)
  set(ps3joy_INSTALL_PREFIX "")
  set(ps3joy_PREFIX ${ps3joy_DEVEL_PREFIX})
else()
  set(ps3joy_SOURCE_PREFIX "")
  set(ps3joy_DEVEL_PREFIX "")
  set(ps3joy_INSTALL_PREFIX /home/robo/Projects/ROSCatkinWorkspace/install)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    ...
    elseif(IS_DIRECTORY /home/robo/Projects/ROSCatkinWorkspace/install/${idir})
      ...
      message(FATAL_ERROR "Project 'ps3joy' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robo/Projects/ROSCatkinWorkspace/install/${idir}'.  Ask the maintainer 'Jonathan Bohren <jbo@jhu.edu>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND ps3joy_LIBRARIES ${${ps3joy_dep}_LIBRARIES})
...
if(ps3joy_LIBRARIES)
  _remove_duplicate_libraries(ps3joy_LIBRARIES ps3joy_LIBRARIES)
endif()
